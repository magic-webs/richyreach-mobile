...
interface GoogleReviewStepReviewProps {
  onPublish: () => void;
  isLoading?: boolean;
}

export function GoogleReviewStepReview({ onPublish, isLoading }: GoogleReviewStepReviewProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subheading}>
        Review your Google Review Arena configuration before launching. Budget coins will be deducted from your wallet.
      </Text>
      ...
      <View style={styles.typeBadge}>
        <HugeiconsIcon icon={StarIcon} size={14} color={Colors.cream} strokeWidth={2} />
        <Text style={styles.typeBadgeText}>Google Review Arena</Text>
      </View>
