...
export function SlideOne({ active }: SlideOneProps) {
      ...
      <View style={{ alignItems: 'center', width: '100%', marginVertical: 16 }}>
        <Animated.View style={[{ alignItems: 'center', width: '100%' }, bottomAnimStyle]}>
          ...
          <Text style={styles.titleText}>
            Earn with{'\n'}
            <Text style={styles.highlightText}>Every Post</Text>
          </Text>

          {/* Underline */}
          <CurvyUnderline width={140} color="#8d4750" />

          {/* Subtitle */}
          <Text style={styles.subtitleText}>Connect. Collaborate. Grow.</Text>
        </Animated.View>
      </View>
    </ScrollView>
  );
